  ...
  render() {    
    return (
      ...
      <div className="drawing light-styles">
        ...
        <p className="turquoise">Here you will find pages about little known phenomena I've collected over the years.</p>
        ...
        <br /><br />
        <div className="nav">
        <a href="">What's a Cryptid?</a>▼<a href="">Photo Gallery (Coming Soon!)</a>▲<a href="">Guestbook</a>
        ▲ ▼
        </div>
